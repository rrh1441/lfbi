...
import { type VulnerabilityMatch, type ComponentVulnerabilityReport } from './versionMatcher.js';
...
function convertVulnerabilityToSBOM(
  ...
  const cyclonVuln: CycloneDXVulnerability = {
    ...
    properties: [
      { name: 'dealbrief:match-confidence', value: vulnerability.matchConfidence.toString() },
      { name: 'dealbrief:match-reason', value: vulnerability.matchReason }
    ]
  };
