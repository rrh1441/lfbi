...
nuclei -sc -headless -u https://projectdiscovery.io -tags tech -silent -timeout 10 || {
...
nuclei -sc -headless -u https://projectdiscovery.io -tags misconfiguration -silent -timeout 10 || {
...
nuclei -sc -headless -u https://projectdiscovery.io -tags tech,misconfiguration,exposed-panels -silent -timeout 10 || {
