...
async function testRateLimitBypass(domain) {
...
export async function runZapRateIp(job) {
    ...
    try {
        ...
        log('[zap-rate-ip] Error during IP rate limit test:', err.message);
        await insertArtifact({
            type: 'rate_limit_ip',
...
//# sourceMappingURL=zapRateIp.js.map